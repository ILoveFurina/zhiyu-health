...
- [x] contracts/order-flow.json 已在 76 加 source 字段；此票确认 drug_order kind 的卡片 schema 字段清单（订单号/status/total_amount/items/prescription_source?）写入契约或 _doc
