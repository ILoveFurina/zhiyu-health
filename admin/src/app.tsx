...
const ADMIN_ONLY_PATHS = ['/hospitals', '/campuses', '/department-categories', '/standard-departments', '/departments', '/doctors', '/schedule-review', '/payments', '/knowledge-graph', '/graph-management', '/knowledge-documents', '/agent-trace', '/demo'];
