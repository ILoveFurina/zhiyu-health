...
INSERT INTO medications (id, name, generic_name, specification, instructions, price, stock, is_prescription) VALUES
    (1, '阿莫西林胶囊', '阿莫西林', '0.25g*24粒', '口服；青霉素过敏者禁用', 18.50, 320, TRUE),
    (2, '布洛芬缓释胶囊', '布洛芬', '0.3g*20粒', '口服；建议餐后服用', 22.00, 280, FALSE),
    (3, '氯雷他定片', '氯雷他定', '10mg*12片', '口服；每日一次', 15.80, 410, FALSE),
    (4, '华法林钠片', '华法林钠', '2.5mg*60片', '口服；须遵医嘱监测凝血指标', 68.00, 90, TRUE),
    (5, '对乙酰氨基酚片', '对乙酰氨基酚', '0.5g*20片', '口服；按医嘱使用，不得超量', 9.50, 500, FALSE),
    (6, '头孢克洛胶囊', '头孢克洛', '0.25g*12粒', '口服；头孢菌素过敏者禁用', 28.00, 200, TRUE),
    (7, '阿奇霉素片', '阿奇霉素', '0.25g*6片', '口服；按医嘱完成疗程', 35.00, 150, TRUE),
    (8, '左氧氟沙星片', '左氧氟沙星', '0.5g*5片', '口服；喹诺酮类过敏者禁用', 24.50, 180, TRUE),
    (9, '奥美拉唑肠溶胶囊', '奥美拉唑', '20mg*14粒', '口服；通常餐前服用', 32.00, 260, TRUE),
    (10, '二甲双胍片', '二甲双胍', '0.5g*20片', '口服；建议随餐服用', 12.00, 380, TRUE),
    (11, '阿卡波糖片', '阿卡波糖', '50mg*30片', '口服；与第一口主食同服', 45.00, 120, TRUE),
    (12, '氨氯地平片', '苯磺酸氨氯地平', '5mg*14片', '口服；按医嘱监测血压', 19.80, 300, TRUE),
    (13, '厄贝沙坦片', '厄贝沙坦', '150mg*7片', '口服；按医嘱监测血压', 26.50, 240, TRUE),
    (14, '美托洛尔缓释片', '琥珀酸美托洛尔', '47.5mg*7片', '口服；不可自行突然停药', 30.00, 170, TRUE),
    (15, '阿托伐他汀钙片', '阿托伐他汀钙', '20mg*7片', '口服；按医嘱监测肝功能', 38.50, 160, TRUE),
    (16, '瑞舒伐他汀钙片', '瑞舒伐他汀钙', '10mg*7片', '口服；按医嘱监测肝功能', 42.00, 140, TRUE),
    (17, '阿司匹林肠溶片', '阿司匹林', '100mg*30片', '口服；有出血风险者须遵医嘱', 14.50, 360, TRUE),
    (18, '氯吡格雷片', '硫酸氢氯吡格雷', '75mg*7片', '口服；有出血风险者须遵医嘱', 56.00, 110, TRUE),
    (19, '蒙脱石散', '蒙脱石', '3g*10袋', '口服；与其他药物错开服用', 16.80, 290, FALSE),
    (20, '多潘立酮片', '多潘立酮', '10mg*30片', '口服；通常餐前服用', 13.50, 270, FALSE),
    (21, '西替利嗪片', '盐酸西替利嗪', '10mg*12片', '口服；每日一次', 17.00, 330, FALSE),
    (22, '孟鲁司特钠片', '孟鲁司特钠', '10mg*5片', '口服；按医嘱使用', 39.00, 130, TRUE),
    (23, '沙丁胺醇吸入气雾剂', '硫酸沙丁胺醇', '100μg*200揿', '吸入；按医嘱使用', 58.00, 85, TRUE),
    (24, '布地奈德吸入粉雾剂', '布地奈德', '200μg*100吸', '吸入；使用后漱口', 72.00, 75, TRUE),
    (25, '左甲状腺素钠片', '左甲状腺素钠', '50μg*100片', '口服；通常空腹服用', 48.00, 100, TRUE),
    (26, '甲巯咪唑片', '甲巯咪唑', '5mg*100片', '口服；按医嘱监测血常规', 21.50, 190, TRUE),
    (27, '碳酸钙D3片', '碳酸钙D3', '600mg*30片', '口服；与部分药物错开服用', 36.00, 230, FALSE),
    (28, '维生素B2片', '核黄素', '5mg*100片', '口服；按医嘱使用', 8.00, 460, FALSE),
    (29, '甲硝唑片', '甲硝唑', '0.2g*20片', '口服；用药期间及停药后避免饮酒', 11.50, 340, TRUE),
    (30, '呋喃妥因肠溶片', '呋喃妥因', '50mg*100片', '口服；硝基呋喃类过敏者禁用', 27.50, 160, TRUE)
ON CONFLICT (id) DO NOTHING;
