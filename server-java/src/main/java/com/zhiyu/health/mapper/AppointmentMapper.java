...
public interface AppointmentMapper extends BaseMapper<Appointment> {
    ...
    @Select("""
            ...
            WHERE patient_id = #{patientId} AND schedule_id = #{scheduleId}
            """)
    Appointment selectForPatientAndSchedule(@Param("patientId") long patientId,
    ...
    @Select("""
            ...
            FOR UPDATE
            """)
    Appointment selectByIdForUpdate(@Param("appointmentId") long appointmentId,
    ...
    @Select("""
            ...
            """)
    List<Appointment> selectViewsByPatient(@Param("patientId") long patientId);
}
