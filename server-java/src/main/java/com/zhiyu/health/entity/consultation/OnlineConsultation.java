package com.zhiyu.health.entity.consultation;
...
/**
 * 在线问诊单实体，镜像 schema.sql online_consultations 表（票 55）。
 * 尾部 @TableField(exist = false) 为科室池/详情联查投影：标准科室名、患者昵称与锁定档案信息；
 * diagnosis/advice 自票 56 起迁存 consultation_records（按 online_consultation_id 关联），
...
public class OnlineConsultation {
    ...
    /** 诊断/医嘱存于 consultation_records（票 56 迁移），详情联查投影；非本表列。 */
